...
from ruhvz.overwrite_fs import OverwriteFileSystemStorage
...
NOUNS = open(os.path.join(settings.BASE_DIR, "ruhvz/game/word-lists/nouns.txt")).read().split('\n')[:-1]
ADJECTIVES = open(os.path.join(settings.BASE_DIR, "ruhvz/game/word-lists/adjs.txt")).read().split('\n')[:-1]
